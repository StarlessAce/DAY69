...
class BlogPost(db.Model, Base):
    ...
    comments_under_post = relationship('Comment', back_populates='parent_post')
...
class Comment(db.Model, Base):
    ...
    parent_post = relationship('BlogPost', back_populates='comments_under_post')
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            new_comment = Comment(text=comment, parent_post=requested_post, comment_author=current_user)
